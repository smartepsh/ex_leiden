...
- [Aggregate] ensure symmetry in aggregate adjacency matrix by averaging with transpose to handle floating point precision issues from matrix multiplication
